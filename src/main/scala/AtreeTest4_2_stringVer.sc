...
class ATree() {
    ...
    var hen: HashMap[String, Node] = HashMap[String, Node]()
    ...
    def insert(_expression: String): Node = {
        ...
        if (_expression.contains('∨')) {
          val collections = _expression.split('∨')
          collections.foreach(x => insert(x))
        }
